    ...
    <div className="flex flex-col items-center overflow-y-scroll justify-center h-full p-8">
      <div className="max-w-md w-full space-y-8 text-center">
        ...
        <div className="space-y-4">
          <div className="mx-auto w-16 h-16 bg-gradient-to-br from-blue-600 via-blue-700 to-orange-600 rounded-full flex items-center justify-center shadow-xl border-2 border-white/10">
        ...
        <Button
          ...
          w-full bg-gradient-to-r from-blue-600 via-blue-700 to-orange-600 hover:from-blue-700 hover:via-blue-800 hover:to-orange-700 text-white py-4 text-lg font-bold transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none border border-white/10
          "
        >
        ...
        <Button
          ...
          w-full bg-gradient-to-r from-green-600 via-green-700 to-orange-600 hover:from-red-700 hover:via-red-800 hover:to-orange-700 text-white py-4 text-lg font-bold transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none border border-white/10
          "
        >
