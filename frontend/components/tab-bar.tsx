...
import { Home, Database, Link, Hash, Mail, Settings } from "lucide-react"
      ...
      {tabs.map((tab) => {
        ...
        return (
          <Button
            ...
            variant="ghost"
            className={cn(
              "flex items-center space-x-2 px-4 py-3 rounded-none border-r border-gray-800 transition-colors duration-150 whitespace-nowrap",
              activeTab === tab.id
